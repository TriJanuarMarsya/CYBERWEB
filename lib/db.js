...
const TABLES = {
  users: { table: 'users', cols: ['id', 'name', 'username', 'email', 'password', 'role', 'phone', 'created'] },
  videos: { table: 'videos', cols: ['id', 'title', 'desc', 'cat', 'tags', 'file', 'size', 'duration', 'thumb', 'upload_by', 'date', 'status'] },
  skrips: { table: 'skrips', cols: ['id', 'title', 'desc', 'cat', 'ver', 'file', 'size', 'upload_by', 'date', 'status'] },
  ...
  notifications: { table: 'notifications', cols: ['id', 'type', 'msg', 'date'] },
